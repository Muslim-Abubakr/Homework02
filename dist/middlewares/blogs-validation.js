...
exports.validationCreateUpdateBlog = [
    ...
    (0, validation_chain_builders_1.body)('websiteUrl').isString().trim().isLength({ min: 1, max: 100 }).withMessage('websiteUrl should not be empty and length min 1 max 100')
