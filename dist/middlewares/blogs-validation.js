...
exports.validationCreateUpdateBlog = [
    (0, validation_chain_builders_1.body)('name').isString().trim().isLength({ min: 1, max: 500 }).withMessage('incorrect name'),
    (0, validation_chain_builders_1.body)('description').isString().trim().isLength({ min: 1, max: 500 }).withMessage('incorrect description'),
    (0, validation_chain_builders_1.body)('websiteUrl').isURL().trim().isLength({ min: 1, max: 100 }).withMessage('incorrect website URL'),
