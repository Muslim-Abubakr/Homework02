...
exports.validationCreateUpdatePost = [
    ...
    (0, validation_chain_builders_1.body)('blogId').notEmpty().isString().trim().withMessage('blogId should be a string').custom(id => {
        const foundBlog = blogs_repository_1.blogsRepository.getBlogsById(id);
        if (!foundBlog) {
